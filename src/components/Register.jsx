...
function Register({ onRegister, onSwitchToLogin, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Registro con API real (NO hace login automático)
      const newUser = await authAPI.register({ name, email: emailNormalized, password })
      
      // Mostrar mensaje de éxito y cerrar modal
      setError('')
      alert(`¡Registro exitoso! Se ha enviado un email de verificación a ${emailNormalized}. Por favor verifica tu email antes de iniciar sesión.`)
